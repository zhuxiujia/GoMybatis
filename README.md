...
# Powerful Features
* <a href="https://zhuxiujia.github.io/gomybatis.io/">High Performance</a>，The maximum number of transactions per second of a single computer can reach 470741Tps/s, and the total time consumed is 0.21s (test environment returns simulated SQL data, concurrently 1000, total 100000, 6-core 16GB win10)<br>
