...
* <a href="https://zhuxiujia.github.io/gomybatis.io/info.html">dynamic sql</a>，contains 15 utilities Features`<select>,<update>,<insert>,<delete>,<trim>,<if>,<set>,<where>,<foreach>,<resultMap>,<bind>,<choose><when><otherwise>,<sql><include>`<br>
